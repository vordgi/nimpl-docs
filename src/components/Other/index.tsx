            ...
            <div className={styles["bg-anim"]}>
                <div className="lg:flex border-t-2 border-b-2 border-neutral-100 border-dashed">
                    <div className="lg:border-r-2 border-neutral-100 border-dashed">
                        <p className="text-4xl h-full lg:w-60 font-medium pt-8 pr-8 pb-8 bg-base-0">Motivation</p>
                    </div>
                ...
                <div className="lg:flex border-b-2 border-neutral-100 border-dashed">
                    <div className="lg:border-r-2 border-neutral-100 border-dashed">
                        <p className="text-4xl h-full lg:w-60 font-medium pt-8 pr-8 pb-8 bg-base-0">Plans</p>
                    </div>
                ...
                <div className="lg:flex border-b-2 border-neutral-100 border-dashed">
                    <div className="lg:border-r-2 border-neutral-100 border-dashed">
                        <p className="text-4xl h-full lg:w-60 font-medium pt-8 pr-8 pb-8 bg-base-0">Additional</p>
                    </div>
