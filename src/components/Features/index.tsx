...
const Features = () => (
    <section className="py-10 sm:py-16 lg:py-32" id="features">
        <div className="container">
            <div className="grid sm:max-xl:grid-cols-4 xl:grid-cols-6 gap-8 items-start">
                <div className={`${styles["bg-circles"]} col-span-2 after:hidden before:top-0 before:left-1/2 overflow-hidden flex flex-col justify-between relative bg-neutral-50 rounded-xl p-8 h-48`}>
                ...
                <div className={`${styles["bg-circles"]} col-span-2 before:bottom-0 before:left-30 after:bottom-0 after:right-0 overflow-hidden flex flex-col justify-between relative bg-neutral-50 rounded-xl p-8 h-48`}>
                ...
                <div className={`${styles["bg-circles"]} col-span-2 before:top-1/4 before:left-1/4 after:bottom-4 after:right-6 overflow-hidden flex flex-col justify-between relative bg-neutral-50 rounded-xl p-8 h-48`}>
                ...
                <div className={`${styles["bg-circles"]} col-span-2 xl:col-span-3 before:right-0 before:bottom-4 after:top-4 after:left-20 overflow-hidden flex flex-col justify-between relative bg-neutral-50 rounded-xl p-8 h-48`}>
                ...
                <div className={`${styles["bg-circles"]} sm:max-xl:col-start-2 col-span-2 xl:col-span-3 before:hidden after:bottom-6 after:left-1/2 overflow-hidden flex flex-col justify-between relative bg-neutral-50 rounded-xl p-8 h-48`}>
