---
title: 'Configuration | @nimpl/cache-adapter'
description: '@nimpl/cache-adapter configuration for remote caching in next.js application'
previewName: cache-adapter-configuration
---
