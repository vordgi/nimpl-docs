...
<Hint>
To use i18n on the client side, you need to set up the [I18nTransmitter](/i18n#i18ntransmitter)
</Hint>
...
<Hint>
The ClientTranslation and client hook [useTranslation](/i18n#usetranslation), unlike server [getTranslation](/i18n#gettranslation) and [ServerTranslation](/i18n#servertranslation), do not support language customization. 
