---
title: 'Usage | @nimpl/config'
description: '@nimpl/config usage in each possible next.js environment (build, server, client, and edge)'
previewName: config-usage
---
...
Before using this config, [additional setup](https://nimpl.tech/config/app-configuration#build) is required
...
Before using this config, [additional setup](https://nimpl.tech/config/app-configuration#postbuild) is required
...
Before using this config, [additional setup](https://nimpl.tech/config/app-configuration#runtime) is required
