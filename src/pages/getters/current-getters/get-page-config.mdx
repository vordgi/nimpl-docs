...
description: 'get-page-config gets the next.js page configuration for the currently rendered page in React Server Component'
previewName: getters-page-config
---
