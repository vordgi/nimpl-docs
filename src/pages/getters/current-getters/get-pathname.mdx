---
title: 'get-pathname | @nimpl/getters'
description: 'get-pathname retrieves pathname for the currently rendered page in React Server Component. Works the same as usePathname, but in a React server component'
previewName: getters-get-pathname
---
