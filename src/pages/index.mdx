...
<section className="pt-32 pb-32">
    <div className="container">
        <div className="grid sm:max-xl:grid-cols-2 xl:grid-cols-3 gap-8 items-start">
            ...
            <a href="/cn" className="block bg-neutral-100 rounded-xl p-8 border-2 border-transparent hover:border-neutral-300">
            ...
            <a href="/cache" className="block bg-neutral-100 rounded-xl p-8 border-2 border-transparent hover:border-neutral-300">
            ...
            <a href="/list" className="block bg-neutral-800 rounded-xl p-8 border-2 border-transparent hover:border-neutral-600 text-neutral-50">
                <p className="font-semibold text-2xl">Other implementations</p>
                <p className="text-xl mt-4">Next-impl is a family of solutions for improving the next.js ecosystem</p>
            </a>
        </div>
    </div>
</section>
