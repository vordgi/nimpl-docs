    ...
    <div className="container">
        <div className="lg:flex border-t-2 border-b-2 border-neutral-100 border-dashed">
            ...
            <div className="text-2xl flex-1 lg:pt-8 pb-8 pl-8">
                ...
                <p>At the same time, much desired functionality is still not implemented. This family of packages solves common next.js tasks, making it not only faster but also simpler.</p>
            </div>
        </div>
